            ...
            <div className="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                {authSection === 'register' &&
                    <div className="intro-x mt-8">
                        <input type="text" className="intro-x login__inpu t form-control py-3 px-4 block" name="fullname" placeholder="Full name" required />
                        <input type="text" className="intro-x login__input form-control py-3 px-4 block mt-4" name="username" placeholder="Username" required />
                        <input type="number" className="intro-x login__input form-control py-3 px-4 block mt-4" name="phone_number" placeholder="Phone Number" required/>
                        <input type="email" className="intro-x login__input form-control py-3 px-4 block mt-4" name="email" id="email" placeholder="Email" required/>
                        <input type="password" className="intro-x login__input form-control py-3 px-4 block mt-4" name="password" id="password" placeholder="Password" required />
                        <input type="password" className="intro-x login__input form-control py-3 px-4 block mt-4" name="confirm_password" placeholder="Password Confirmation" required />
                    </div>
                }
                {!authSection &&
                    <div className="intro-x mt-8">
                        <input type="text" className="intro-x login__input form-control py-3 px-4 block mt-4" name="email" id="email" placeholder="Email" required />
                        <input type="password" className="intro-x login__input form-control py-3 px-4 block mt-4" name="password" id="password" placeholder="Password" required />
                    </div>
                }
                {/* Login Form Section */}
